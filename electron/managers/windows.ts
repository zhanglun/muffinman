...
export class WindowManager {
  ...
  // 更新指定webview的边界
  updateWebViewBounds(id: string, bounds: { x: number; y: number; width: number; height: number }): boolean {
